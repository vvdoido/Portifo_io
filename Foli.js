function adjustPhoneDisplay() {
    ...
    if (window.innerWidth <= 575.98) {
        ...
        if (!navbarToggler.contains(phoneContainer)) {
            navbarToggler.insertAdjacentElement('afterend', phoneContainer);
...
window.addEventListener('load', adjustPhoneDisplay);
window.addEventListener('resize', adjustPhoneDisplay);
